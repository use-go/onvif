...
func Call_LoadCertificateWithPrivateKey(ctx context.Context, dev *onvif.Device, request LoadCertificateWithPrivateKey) (LoadCertificateWithPrivateKeyResponse, error) {
