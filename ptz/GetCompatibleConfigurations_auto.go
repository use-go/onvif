...
func Call_GetCompatibleConfigurations(ctx context.Context, dev *onvif.Device, request GetCompatibleConfigurations) (GetCompatibleConfigurationsResponse, error) {
