...
func Call_RemoveAudioEncoderConfiguration(ctx context.Context, dev *onvif.Device, request RemoveAudioEncoderConfiguration) (RemoveAudioEncoderConfigurationResponse, error) {
