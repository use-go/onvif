...
func Call_SetVideoAnalyticsConfiguration(ctx context.Context, dev *onvif.Device, request SetVideoAnalyticsConfiguration) (SetVideoAnalyticsConfigurationResponse, error) {
