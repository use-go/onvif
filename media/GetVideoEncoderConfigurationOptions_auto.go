...
func Call_GetVideoEncoderConfigurationOptions(ctx context.Context, dev *onvif.Device, request GetVideoEncoderConfigurationOptions) (GetVideoEncoderConfigurationOptionsResponse, error) {
