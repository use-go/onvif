...
func Call_AddVideoEncoderConfiguration(ctx context.Context, dev *onvif.Device, request AddVideoEncoderConfiguration) (AddVideoEncoderConfigurationResponse, error) {
