...
func Call_GetVideoSourceConfiguration(ctx context.Context, dev *onvif.Device, request GetVideoSourceConfiguration) (GetVideoSourceConfigurationResponse, error) {
