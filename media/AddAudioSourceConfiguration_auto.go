...
func Call_AddAudioSourceConfiguration(ctx context.Context, dev *onvif.Device, request AddAudioSourceConfiguration) (AddAudioSourceConfigurationResponse, error) {
