...
func Call_GetVideoAnalyticsConfigurations(ctx context.Context, dev *onvif.Device, request GetVideoAnalyticsConfigurations) (GetVideoAnalyticsConfigurationsResponse, error) {
