...
func Call_RemoveVideoSourceConfiguration(ctx context.Context, dev *onvif.Device, request RemoveVideoSourceConfiguration) (RemoveVideoSourceConfigurationResponse, error) {
