...
func Call_GetCompatibleAudioDecoderConfigurations(ctx context.Context, dev *onvif.Device, request GetCompatibleAudioDecoderConfigurations) (GetCompatibleAudioDecoderConfigurationsResponse, error) {
