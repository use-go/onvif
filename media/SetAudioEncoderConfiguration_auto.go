...
func Call_SetAudioEncoderConfiguration(ctx context.Context, dev *onvif.Device, request SetAudioEncoderConfiguration) (SetAudioEncoderConfigurationResponse, error) {
