...
func Call_GetAudioSourceConfigurationOptions(ctx context.Context, dev *onvif.Device, request GetAudioSourceConfigurationOptions) (GetAudioSourceConfigurationOptionsResponse, error) {
