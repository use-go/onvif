...
func Call_GetCompatibleVideoSourceConfigurations(ctx context.Context, dev *onvif.Device, request GetCompatibleVideoSourceConfigurations) (GetCompatibleVideoSourceConfigurationsResponse, error) {
