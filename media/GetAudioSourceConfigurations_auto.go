...
func Call_GetAudioSourceConfigurations(ctx context.Context, dev *onvif.Device, request GetAudioSourceConfigurations) (GetAudioSourceConfigurationsResponse, error) {
