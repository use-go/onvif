...
func Call_GetAudioEncoderConfigurations(ctx context.Context, dev *onvif.Device, request GetAudioEncoderConfigurations) (GetAudioEncoderConfigurationsResponse, error) {
