...
func Call_GetAudioOutputConfiguration(ctx context.Context, dev *onvif.Device, request GetAudioOutputConfiguration) (GetAudioOutputConfigurationResponse, error) {
