...
func Call_RemoveAudioOutputConfiguration(ctx context.Context, dev *onvif.Device, request RemoveAudioOutputConfiguration) (RemoveAudioOutputConfigurationResponse, error) {
