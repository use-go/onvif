...
func Call_GetCompatibleAudioSourceConfigurations(ctx context.Context, dev *onvif.Device, request GetCompatibleAudioSourceConfigurations) (GetCompatibleAudioSourceConfigurationsResponse, error) {
