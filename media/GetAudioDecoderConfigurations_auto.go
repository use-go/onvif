...
func Call_GetAudioDecoderConfigurations(ctx context.Context, dev *onvif.Device, request GetAudioDecoderConfigurations) (GetAudioDecoderConfigurationsResponse, error) {
