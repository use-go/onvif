...
func Call_SetVideoEncoderConfiguration(ctx context.Context, dev *onvif.Device, request SetVideoEncoderConfiguration) (SetVideoEncoderConfigurationResponse, error) {
