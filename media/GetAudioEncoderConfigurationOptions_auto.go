...
func Call_GetAudioEncoderConfigurationOptions(ctx context.Context, dev *onvif.Device, request GetAudioEncoderConfigurationOptions) (GetAudioEncoderConfigurationOptionsResponse, error) {
