...
func Call_SetVideoSourceConfiguration(ctx context.Context, dev *onvif.Device, request SetVideoSourceConfiguration) (SetVideoSourceConfigurationResponse, error) {
