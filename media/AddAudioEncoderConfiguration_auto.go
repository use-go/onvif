...
func Call_AddAudioEncoderConfiguration(ctx context.Context, dev *onvif.Device, request AddAudioEncoderConfiguration) (AddAudioEncoderConfigurationResponse, error) {
