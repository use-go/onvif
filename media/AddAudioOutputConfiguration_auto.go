...
func Call_AddAudioOutputConfiguration(ctx context.Context, dev *onvif.Device, request AddAudioOutputConfiguration) (AddAudioOutputConfigurationResponse, error) {
