...
func Call_GetAudioOutputConfigurations(ctx context.Context, dev *onvif.Device, request GetAudioOutputConfigurations) (GetAudioOutputConfigurationsResponse, error) {
