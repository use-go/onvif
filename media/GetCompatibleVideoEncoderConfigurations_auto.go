...
func Call_GetCompatibleVideoEncoderConfigurations(ctx context.Context, dev *onvif.Device, request GetCompatibleVideoEncoderConfigurations) (GetCompatibleVideoEncoderConfigurationsResponse, error) {
