...
func Call_GetCompatibleAudioOutputConfigurations(ctx context.Context, dev *onvif.Device, request GetCompatibleAudioOutputConfigurations) (GetCompatibleAudioOutputConfigurationsResponse, error) {
