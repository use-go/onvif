...
func Call_GetVideoSourceConfigurationOptions(ctx context.Context, dev *onvif.Device, request GetVideoSourceConfigurationOptions) (GetVideoSourceConfigurationOptionsResponse, error) {
