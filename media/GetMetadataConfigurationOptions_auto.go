...
func Call_GetMetadataConfigurationOptions(ctx context.Context, dev *onvif.Device, request GetMetadataConfigurationOptions) (GetMetadataConfigurationOptionsResponse, error) {
